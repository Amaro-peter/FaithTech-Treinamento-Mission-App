...
import { Avatar, Box, Button, Container, Flex, Text, Image, Divider } from '@chakra-ui/react';
  ...
  return (
    ...
    >
        ...
        >
            ...
            gap={{base: 4, sm: 7}}
            >
                <Avatar src='' alt="Missinary" size={{base: "md", md: "lg"}} />
            ...
            >
                ...
                textAlign={"justify"}
                >
                    Vivendo para o Reino. Missionárina na África do Sul.
                </Text>
            </Flex>
